...
//        if(productCategory.equals("true")){
//            //product has category
//            holder.productCategoryTv.setVisibility(View.VISIBLE);
//        }
//        else{
//            //product has no category
//            holder.productCategoryTv.setVisibility(View.GONE);
//        }
    ...
    private void detailPage(ModelProduct modelProduct) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.product_detail_company,null);
        //set view to bottom sheet
        bottomSheetDialog.setContentView(view);

        //init views
        ImageView editBtn = view.findViewById(R.id.edit);
...
//                bottomSheetDialog.dismiss();
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Delete")
                        .setMessage("Are you sure want to delete product " + productName + "?")
                        .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                bottomSheetDialog.dismiss();
                                addToNotifications(""+productName,""+productCompany,"delete");
    ...
    private void addToNotifications(String productName,String productCompany, String notification) {
