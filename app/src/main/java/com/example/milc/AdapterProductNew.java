...
public class AdapterProductNew extends RecyclerView.Adapter<AdapterProductNew.HolderProduct> implements Filterable {

    private Context context;
    public ArrayList<ModelProduct> productList, filterList;
    private FilterProductNew filter;
...
////*****************************************************************************VITAMIN
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterProductNew(this,filterList);
        }
        return filter;
    }
