...
public class Dietitian_Glucerna extends AppCompatActivity {
    ...
    TextView VitaminA,VitaminD3,VitaminE,VitaminK1,VitaminC,VitaminB1,VitaminB2,VitaminB6,VitaminB12,Niacin,Folic,Biotin,Pantothenic,Inositol;
    TextView Energy,Protein,Fat,MUFA,PUFA,Linoleic,LinoAcid,SFA,Trans,Cholesterol,Carbohydrate,Polyols,Choline,Fibre,Lactose,FOS,Taurine,Carnitine;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dietitian_glucerna);
        ...
        Inositol = findViewById(R.id.Inositol);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Dietitian_Glucerna.this, Dietitian_AdultFormula.class);
                startActivity(i);
                finish();
            }
        });

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products Info").child("t5aTq32ZMaP33c16tCaOrFvaKyt2").child("1649958774561");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Inositol.setText(snapshot.child("product InositolUnit").getValue().toString());
