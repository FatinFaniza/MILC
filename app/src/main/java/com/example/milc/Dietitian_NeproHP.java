...
public class Dietitian_NeproHP extends AppCompatActivity {
    ...
    TextView Sodium,Potassium,Chloride,Calcium,Phosphorus,Magnesium,Iron,Zinc,Manganese,Copper,Iodine,Selenium,Chromium,Molybdenum,Water;
    TextView Energy,Protein,Fat,MUFA,PUFA,Linoleic,LinoAcid,SFA,Trans,Carbohydrate,Polyols,Totalsugar,Fiber,Dietaryfiber,FOS,Choline,Taurine,Carnitine;
    TextView VitaminA1,VitaminD3,VitaminE,VitaminK1,VitaminC,VitaminB1,VitaminB2,VitaminB6,VitaminB12,Niacin,Folic,Biotin,Pantothenic;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dietitian_nepro_hp);
        ...
        Polyols = findViewById(R.id.Polyols);
        Carnitine = findViewById(R.id.Carnitine);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Dietitian_NeproHP.this, Dietitian_AdultFormula.class);
                startActivity(i);
                finish();
            }
        });

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products Info").child("t5aTq32ZMaP33c16tCaOrFvaKyt2").child("1649960954263");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                retailPrice.setText(retail);
                        ...
                        Polyols.setText(snapshot.child("product PolyolsUnit").getValue().toString());
                        ...
                        Carnitine.setText(snapshot.child("product CarnitineUnit").getValue().toString());
                        ...
                        Water.setText(snapshot.child("product WaterUnit").getValue().toString());
