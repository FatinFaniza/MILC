...
public class Dietitian_Prosure extends AppCompatActivity {
    ...
    TextView Energy,Protein,Fat,MUFA,PUFA,Linoleic,LinoAcid,EPA,DHA,SFA,Trans,Carbohydrate,Fiber,Dietaryfiber,FOS,Choline,Taurine,Carnitine;
    TextView VitaminA,VitaminA2,VitaminD3,VitaminE,VitaminK1,VitaminC,VitaminB1,VitaminB2,VitaminB6,VitaminB12,Niacin,Folic,Biotin,Pantothenic;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dietitian_prosure);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Dietitian_Prosure.this, Dietitian_AdultFormula.class);
                startActivity(i);
                finish();
            }
        });

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Products Info").child("t5aTq32ZMaP33c16tCaOrFvaKyt2").child("1649972806785");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                EPA.setText(snapshot.child("product EPAUnit").getValue().toString());
                DHA.setText(snapshot.child("product DHAUnit").getValue().toString());
