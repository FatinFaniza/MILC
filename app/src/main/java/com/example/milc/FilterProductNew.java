...
public class FilterProductNew extends Filter {

    private AdapterProductNew adapter;
    private ArrayList<ModelProduct> filterList;

    public FilterProductNew(AdapterProductNew adapter, ArrayList<ModelProduct> filterList ) {
