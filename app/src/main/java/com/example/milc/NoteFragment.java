    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatBtnAddNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), NoteEditor.class);
                startActivity(i);
            }
        });
        ...
        //query
        Query query = db.collection("Notes").document(firebaseAuth.getUid()).collection("Dietitian").orderBy("title",Query.Direction.ASCENDING);
        ...
        adapter = new FirestoreRecyclerAdapter<Note, NoteFragment.NoteViewHolder>(options) {
            @NonNull
            @Override
            public NoteFragment.NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new NoteFragment.NoteViewHolder(v);
            }

            @RequiresApi(api = Build.VERSION_CODES.M)
            @Override
            protected void onBindViewHolder(@NonNull NoteFragment.NoteViewHolder holder, int position, @NonNull Note model) {
                        ...
                        popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                DocumentReference documentReference = firebaseFirestore.collection("Notes")
                                        .document(firebaseAuth.getUid()).collection("Dietitian").document(model.getItemId());
