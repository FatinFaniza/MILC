    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatBtnAddNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), NoteEditor3.class);
                startActivity(i);
            }
        });
        ...
        //query
        Query query = db.collection("Notes").document(firebaseAuth.getUid()).collection("ProductUser").orderBy("title",Query.Direction.ASCENDING);
        ...
        adapter = new FirestoreRecyclerAdapter<Note, NoteFragment3.NoteViewHolder>(options) {
            @NonNull
            @Override
            public NoteFragment3.NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.notes_layout, parent, false);

                return new NoteFragment3.NoteViewHolder(v);
            }
...
//                holder.note.setBackgroundColor(holder.itemView.getResources().getColor(colorCode,null));
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(v.getContext(),NoteView3.class);
                        ...
                        popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                DocumentReference documentReference = firebaseFirestore.collection("Notes")
                                        .document(firebaseAuth.getUid()).collection("ProductUser").document(model.getItemId());
...
//        colorCode.add(R.color.color_7);
//        colorCode.add(R.color.color_8);
//        colorCode.add(R.color.color_9);
//        colorCode.add(R.color.color_10);
//        colorCode.add(R.color.color_11);
//
