...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<ModelProduct> uploads) {
        mContext = context;
        products = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ModelProduct currentProduct = products.get(position);

        //from xml
        holder.NameTv.setText(currentProduct.getProductName());
        holder.DescriptionTv.setText(currentProduct.getProductDescription());
        holder.CategoryTv.setText(currentProduct.getProductCategory());
        holder.SubCategoryTv.setText(currentProduct.getProductSubCategory());
        Picasso.get()
                .load(currentProduct.getProductIcon())
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public TextView NameTv,DescriptionTv,CategoryTv,SubCategoryTv;
        ...
        public RecyclerViewHolder(View itemView) {
            ...
            ProductIv = itemView.findViewById(R.id.teacherImageView);
            CategoryTv = itemView.findViewById(R.id.CategoryTextView);
            SubCategoryTv = itemView.findViewById(R.id.SubCategoryTextView);
